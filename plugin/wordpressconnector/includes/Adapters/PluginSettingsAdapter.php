...
final class PluginSettingsAdapter
{
    ...
    private const INTEGRATIONS = array(
        ...
        'code-snippets/code-snippets.php' => array('id' => 'code_snippets', 'mode' => 'blocked_arbitrary_code', 'actions' => array(), 'note' => 'Snippet execution remains outside the plugin-settings contract; source-file maintenance, when explicitly enabled, uses the separate bounded filesystem contract.'),
