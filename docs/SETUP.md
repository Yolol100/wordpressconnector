...
9. If Elementor Pro Theme Builder is used, test **Export Elementor + Site Parts** on a page with an assigned header/footer.
10. Only then enable the minimum production write gates required for the workflow.
